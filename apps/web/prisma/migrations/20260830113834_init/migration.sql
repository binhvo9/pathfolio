-- CreateEnum
CREATE TYPE "Goal" AS ENUM ('RETIREMENT', 'HOUSE_DEPOSIT', 'GENERAL_GROWTH');

-- CreateEnum
CREATE TYPE "RiskBand" AS ENUM ('CONSERVATIVE', 'BALANCED', 'GROWTH', 'AGGRESSIVE');

-- CreateEnum
CREATE TYPE "IncomeTiltBand" AS ENUM ('INCOME_FOCUSED', 'BALANCED', 'GROWTH_FOCUSED');
...
CREATE TABLE "RiskProfile" (
    ...
    "riskScore" INTEGER,
    "riskBand" "RiskBand",
    "incomeTiltScore" INTEGER,
    "incomeTiltBand" "IncomeTiltBand",
    "defaultAllocation" JSONB,
